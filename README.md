...
To build the final jar and optimize the pointagePresenceApp application for production, run:
...
Then navigate to [http://localhost:9005](http://localhost:9005) in your browser.
