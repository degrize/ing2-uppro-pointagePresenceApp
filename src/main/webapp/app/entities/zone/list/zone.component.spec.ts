...
describe('Zone Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'zone', component: ZoneComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to zoneService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getZoneIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getZoneIdentifier).toHaveBeenCalledWith(entity);
